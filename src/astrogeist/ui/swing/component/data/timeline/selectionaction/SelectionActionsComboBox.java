...
public class SelectionActionsComboBox 
	extends JComboBox<AbstractSelectionAction> {
	...
	public SelectionActionsComboBox() {
	    ...
	    super.setModel(new DefaultComboBoxModel<>(actions.toArray(
	    	AbstractSelectionAction.EMPTY_ARRAY)));
	    
	    super.setRenderer((list, value, index, isSelected, cellHasFocus) -> {
	        var lbl = new DefaultListCellRenderer();
	        lbl = as(DefaultListCellRenderer.class, 
	        	lbl.getListCellRendererComponent(list,
	        		value == null ? Strings.EMPTY : value.getName(), index, 
