...
public sealed interface TaskEvent
	permits TaskEvent.Progress, TaskEvent.Log, TaskEvent.Error,
		TaskEvent.State {

    record Progress(String stepId, int overallPercent, String message)
    ...
    static Log log(String msg) { return new Log(msg); }
