...
public final class JobProgressTableModel extends AbstractTableModel {
    ...
    private static final String[] COLS = {
        "Name", "Status", "Progress", "OK", "Failed", "Description" };
    ...
    public final JobProgress getAt(int row) {
        return (row >= 0 && row < rows.size()) ? rows.get(row) : null; }

    public final void jobUpdated(JobProgress job) {
    ...
    @Override public final Object getValueAt(int r, int c) {
