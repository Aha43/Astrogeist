...
public final class SelectSnapshotConfigurationAction extends AbstractAction {
	...
	public SelectSnapshotConfigurationAction(App app) {
		super("Configuration");
	...
	@Override public final void actionPerformed(ActionEvent e) {
		...
		var selected = SelectConfigurationDialog.show(this.app, code);
		if (selected != null) {
			updateSnapshot(selected);
		}
	}
	...
	private final void updateSnapshot(Configuration selected) {
		...
		var tlv = this.timelineValuePool.get(name, selected.code());
